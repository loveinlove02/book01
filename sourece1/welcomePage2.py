...
class WelcomePage(tk.Frame):
    ...
    def create_widgets(self):
        self.welcome_page_fm = tk.Frame(self, highlightbackground=self.asstes.bg_color, highlightthickness=2, bg='#FFFFFF')
        self.welcome_page_fm.pack(pady=0)
        self.welcome_page_fm.configure(width=890, height=780)


        self.title_frame = tk.Frame(self.welcome_page_fm, bg=self.asstes.bg_color)
        self.title_frame.place(x=0, y=0)
        self.title_frame.configure(width=890, height=45)

        self.title_lable = tk.Label(self.welcome_page_fm, fg='#119F46', text='AI 셀프 대출반납기 입니다',
                                    font='arial 25', bg='#FFFFFF')
        self.title_lable.place(x=280, y=100)
        ...
        self.center_logo_button.place(x=340, y=190)
        ...
        self.bottom_frame = tk.Frame(self.welcome_page_fm, bg='#F5EBDD')
        self.bottom_frame.place(x=0, y=455)
        self.bottom_frame.configure(width=885, height=319)
        ...
        self.borrow_btn = tk.Button(self.bottom_frame, image=self.book_logo1, bg='#F5EBDD', bd=0, command=self.forwad_to_borrow_page)
        self.borrow_btn.place(x=150, y=38)

        self.return_btn = tk.Button(self.bottom_frame, image=self.book_logo2, bg='#F5EBDD', bd=0, command=self.forwad_to_return_page)
        self.return_btn .place(x=480, y=38)

        self.borrow_label = tk.Label(self.bottom_frame, text='대출', font='arial 25', bg='#F5EBDD')
        self.borrow_label.place(x=240, y=245)

        self.return_label = tk.Label(self.bottom_frame, text='반납', font='arial 25', bg='#F5EBDD')
        self.return_label.place(x=568, y=245)
